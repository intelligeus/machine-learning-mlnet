...
namespace TitanicApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"../../../data/titanic-train-data.csv";
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.MulticlassClassification.CrossValidate(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "Survived");
